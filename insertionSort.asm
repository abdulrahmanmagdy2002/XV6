...
_insertionSort:     file format elf32-i386
...
main(int argc, char* argv[])
{
  ...
  1f:	0f 8e a4 00 00 00    	jle    c9 <main+0xc9>
    {
  ...
  6e:	ff 74 b8 04          	push   0x4(%eax,%edi,4)
  72:	e8 99 02 00 00       	call   310 <atoi>
    for (int i = 0; i < n; i++)
  77:	83 c4 10             	add    $0x10,%esp
        arr[i] = atoi(argv[i+1]);
  7a:	89 04 be             	mov    %eax,(%esi,%edi,4)
    for (int i = 0; i < n; i++)
  7d:	83 c7 01             	add    $0x1,%edi
  80:	39 fb                	cmp    %edi,%ebx
  82:	75 e4                	jne    68 <main+0x68>
    }
  ...
  89:	53                   	push   %ebx
  8a:	56                   	push   %esi
  8b:	e8 50 00 00 00       	call   e0 <insertionSort>
  ...
  9b:	ff 34 be             	push   (%esi,%edi,4)
    for (int i = 0; i < n; i++)
  9e:	83 c7 01             	add    $0x1,%edi
        printf(1 , "%d ", arr[i]);
  a1:	68 3d 08 00 00       	push   $0x83d
  a6:	6a 01                	push   $0x1
  a8:	e8 33 04 00 00       	call   4e0 <printf>
    for (int i = 0; i < n; i++)
  ad:	83 c4 10             	add    $0x10,%esp
  b0:	39 fb                	cmp    %edi,%ebx
  b2:	75 e4                	jne    98 <main+0x98>
    }
    return 0;
  b4:	8d 65 f0             	lea    -0x10(%ebp),%esp
  ...
  bc:	5f                   	pop    %edi
  bd:	5d                   	pop    %ebp
  be:	8d 61 fc             	lea    -0x4(%ecx),%esp
  c1:	c3                   	ret    
    int arr[n];
  c2:	83 4c 14 fc 00       	orl    $0x0,-0x4(%esp,%edx,1)
  c7:	eb 96                	jmp    5f <main+0x5f>
        printf(1, "Usage: insertionSort <number> <number> <number> ...\n");
  c9:	50                   	push   %eax
  ca:	50                   	push   %eax
  cb:	68 08 08 00 00       	push   $0x808
  d0:	6a 01                	push   $0x1
  d2:	e8 09 04 00 00       	call   4e0 <printf>
        exit();
  d7:	e8 a7 02 00 00       	call   383 <exit>
  dc:	66 90                	xchg   %ax,%ax
  de:	66 90                	xchg   %ax,%ax

000000e0 <insertionSort>:
{
  e0:	55                   	push   %ebp
  e1:	89 e5                	mov    %esp,%ebp
  e3:	57                   	push   %edi
    for (int i = 1; i < n; i++) 
  e4:	83 7d 0c 01          	cmpl   $0x1,0xc(%ebp)
{
  e8:	8b 55 08             	mov    0x8(%ebp),%edx
  eb:	56                   	push   %esi
  ec:	53                   	push   %ebx
    for (int i = 1; i < n; i++) 
  ed:	7e 30                	jle    11f <insertionSort+0x3f>
  ef:	bf 01 00 00 00       	mov    $0x1,%edi
  f4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        value = arr[i];
  f8:	8b 1c ba             	mov    (%edx,%edi,4),%ebx
        while (j >= 0 && arr[j] > value) 
  fb:	89 f8                	mov    %edi,%eax
  fd:	8d 76 00             	lea    0x0(%esi),%esi
 100:	8b 4c 82 fc          	mov    -0x4(%edx,%eax,4),%ecx
 104:	8d 34 82             	lea    (%edx,%eax,4),%esi
 107:	39 d9                	cmp    %ebx,%ecx
 109:	7e 0a                	jle    115 <insertionSort+0x35>
            arr[j + 1] = arr[j];
 10b:	89 0c 82             	mov    %ecx,(%edx,%eax,4)
        while (j >= 0 && arr[j] > value) 
 10e:	83 e8 01             	sub    $0x1,%eax
 111:	75 ed                	jne    100 <insertionSort+0x20>
 113:	89 d6                	mov    %edx,%esi
        arr[j + 1] = value;
 115:	89 1e                	mov    %ebx,(%esi)
    for (int i = 1; i < n; i++) 
 117:	83 c7 01             	add    $0x1,%edi
 11a:	39 7d 0c             	cmp    %edi,0xc(%ebp)
 11d:	75 d9                	jne    f8 <insertionSort+0x18>
}
 11f:	5b                   	pop    %ebx
 120:	5e                   	pop    %esi
 121:	5f                   	pop    %edi
...
free(void *ap)
{
 ...
 681:	a1 98 0b 00 00       	mov    0xb98,%eax
{
 ...
 6c1:	5b                   	pop    %ebx
  freep = p;
 6c2:	89 15 98 0b 00 00    	mov    %edx,0xb98
}
 6c8:	5e                   	pop    %esi
 6c9:	5f                   	pop    %edi
 6ca:	5d                   	pop    %ebp
 ...
 6f9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6fc:	89 15 98 0b 00 00    	mov    %edx,0xb98
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 719:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 71c:	8b 3d 98 0b 00 00    	mov    0xb98,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 75f:	73 4f                	jae    7b0 <malloc+0xa0>
    ...
    if(p == freep)
 761:	8b 3d 98 0b 00 00    	mov    0xb98,%edi
 ...
 78a:	e8 f1 fe ff ff       	call   680 <free>
  return freep;
 78f:	8b 15 98 0b 00 00    	mov    0xb98,%edx
 ...
 7bc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7bf:	89 15 98 0b 00 00    	mov    %edx,0xb98
}
 ...
 7cf:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7d0:	c7 05 98 0b 00 00 9c 	movl   $0xb9c,0xb98
 7d7:	0b 00 00 
    base.s.size = 0;
 7da:	bf 9c 0b 00 00       	mov    $0xb9c,%edi
    base.s.ptr = freep = prevp = &base;
 7df:	c7 05 9c 0b 00 00 9c 	movl   $0xb9c,0xb9c
 7e6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7e9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7eb:	c7 05 a0 0b 00 00 00 	movl   $0x0,0xba0
 7f2:	00 00 00 
    if(p->s.size >= nunits){
