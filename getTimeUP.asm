...
_getTimeUP:     file format elf32-i386
...
int main(int argc, char *argv[]) {
  11:	83 ec 30             	sub    $0x30,%esp
    if (getTime(&r) < 0) {
  14:	50                   	push   %eax
  15:	e8 39 03 00 00       	call   353 <getTime>
  1a:	83 c4 10             	add    $0x10,%esp
  1d:	85 c0                	test   %eax,%eax
  1f:	78 26                	js     47 <main+0x47>
 ...
 36c:	89 d1                	mov    %edx,%ecx
{
 ...
 399:	0f b6 92 e4 07 00 00 	movzbl 0x7e4(%edx),%edx
 ...
 419:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 489:	ff 24 85 8c 07 00 00 	jmp    *0x78c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 597:	90                   	nop
          s = "(null)";
 598:	ba 82 07 00 00       	mov    $0x782,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5b1:	a1 8c 0a 00 00       	mov    0xa8c,%eax
{
 ...
 5f1:	5b                   	pop    %ebx
  freep = p;
 5f2:	89 15 8c 0a 00 00    	mov    %edx,0xa8c
}
 5f8:	5e                   	pop    %esi
 5f9:	5f                   	pop    %edi
 5fa:	5d                   	pop    %ebp
 ...
 629:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 62c:	89 15 8c 0a 00 00    	mov    %edx,0xa8c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 649:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 64c:	8b 3d 8c 0a 00 00    	mov    0xa8c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 68f:	73 4f                	jae    6e0 <malloc+0xa0>
    ...
    if(p == freep)
 691:	8b 3d 8c 0a 00 00    	mov    0xa8c,%edi
 ...
 6ba:	e8 f1 fe ff ff       	call   5b0 <free>
  return freep;
 6bf:	8b 15 8c 0a 00 00    	mov    0xa8c,%edx
 ...
 6ec:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 6ef:	89 15 8c 0a 00 00    	mov    %edx,0xa8c
}
 ...
 6ff:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 700:	c7 05 8c 0a 00 00 90 	movl   $0xa90,0xa8c
 707:	0a 00 00 
    base.s.size = 0;
 70a:	bf 90 0a 00 00       	mov    $0xa90,%edi
    base.s.ptr = freep = prevp = &base;
 70f:	c7 05 90 0a 00 00 90 	movl   $0xa90,0xa90
 716:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 719:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 71b:	c7 05 94 0a 00 00 00 	movl   $0x0,0xa94
 722:	00 00 00 
    if(p->s.size >= nunits){
